...
```{r polt_catch}
plot_catch <- ggplot(new_my_df,aes(X)) +  geom_point(aes(y = fbar,colour="zasolenie"), size=0.7) +
  geom_smooth(aes(y=fbar,colour = "zasolenie trend"),method="auto",size=1.7)+
  facet_wrap(~xmonth) + 
  theme_minimal() + theme(axis.text.x=element_blank(),axis.ticks.x=element_blank()) + 
  labs(x = "Czas", y = "Zasolenie ") + ggtitle("Wykres fbar od czasu") 
plot_catch
```
...
```{r polt_totaln}
plot_totaln <- ggplot(new_my_df,aes(X)) +  geom_point(aes(y = totaln,colour="zasolenie"), size=0.7) +
  geom_smooth(aes(y=totaln,colour = "zasolenie trend"),method="auto",size=1.7)+
  facet_wrap(~xmonth) + 
  theme_minimal() + theme(axis.text.x=element_blank(),axis.ticks.x=element_blank()) + 
  labs(x = "Czas", y = "Zasolenie ") + ggtitle("Wykres totaln od czasu") 
plot_totaln
```
...
```{r polt_catch_year}
plot_catch <- ggplot(new_my_df,aes(X)) +  geom_point(aes(y = cumf,colour="zasolenie"), size=1) +
  geom_smooth(aes(y=cumf,colour = "zasolenie trend"),method="auto",size=1.7)+
  theme_minimal() + theme(axis.text.x=element_blank(),axis.ticks.x=element_blank()) + 
  labs(x = "Czas", y = "Zasolenie ") + ggtitle("Wykres  cumf  czasu") 
plot_catch
```
...
```{r polt_fry_year}
plot_fry <- ggplot(new_my_df,aes(X)) +  geom_point(aes(y = recr,colour="zasolenie"), size=1) +
  geom_smooth(aes(y=recr,colour = "zasolenie trend"),method="auto",size=1.7)+
  theme_minimal() + theme(axis.text.x=element_blank(),axis.ticks.x=element_blank()) + 
  labs(x = "Czas", y = "Zasolenie ") + ggtitle("Wykres recr od czasu") 
plot_fry
```
...
```{r correlation}
#cor(df_norm_plank, use="complete.obs", method="kendall")
```
