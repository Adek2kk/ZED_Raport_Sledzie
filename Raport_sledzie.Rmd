...
```
```{r plot_sst_hist}
plot_sst_hist<- ggplot(new_my_df,aes(sst)) + geom_histogram(binwidth=0.2, color="darkblue", fill="lightblue") +
...
```{r plot_sal_hist}
plot_sal_hist<- ggplot(new_my_df,aes(sal)) + geom_histogram(binwidth=0.05, color="darkblue", fill="lightblue") +
...
```
```{r plot_fbar_hist}
plot_fbar_hist<- ggplot(new_my_df,aes(fbar)) + geom_histogram(binwidth=0.05, color="darkblue", fill="lightblue") +
...
```
```{r plot_totaln_hist}
plot_totaln_hist<- ggplot(new_my_df,aes(totaln)) + geom_histogram(binwidth=100000, color="darkblue", fill="lightblue") +
...
corr <- round(corr,2)
corr_melt <- melt(corr)
corr_plot <- ggplot(corr_melt, aes(Var1, Var2)) + geom_tile(aes(fill = value), colour = "white") + scale_fill_gradient2(low = "red", mid = "white", high = "steelblue") + geom_text(aes(label=value))
corr_plot
