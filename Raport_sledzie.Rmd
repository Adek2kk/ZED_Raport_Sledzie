...
```
```{r plot_cfin1_hist}
plot_cfin1_hist<- ggplot(df_norm_plank,aes(cfin1)) + geom_histogram(binwidth=0.05, color="white", fill="steelblue") + theme_minimal() + labs(x = "Plankton", y = "Liczba") + ggtitle("Histogram poziomu planktonu") 
...
```
```{r plot_cfin2_hist}
plot_cfin2_hist<- ggplot(df_norm_plank,aes(cfin2)) + geom_histogram(binwidth=0.05, color="white", fill="steelblue") + theme_minimal() + labs(x = "Plankton", y = "Liczba") + ggtitle("Histogram poziomu planktonu") 
...
```
```{r plot_chel1_hist}
plot_chel1_hist<- ggplot(df_norm_plank,aes(chel1)) + geom_histogram(binwidth=0.05, color="white", fill="steelblue") + theme_minimal() + labs(x = "Plankton", y = "Liczba") + ggtitle("Histogram poziomu planktonu") 
...
```
```{r plot_chel2_hist}
plot_chel2_hist<- ggplot(df_norm_plank,aes(chel2)) + geom_histogram(binwidth=0.05, color="white", fill="steelblue") + theme_minimal() + labs(x = "Plankton", y = "Liczba") + ggtitle("Histogram poziomu planktonu") 
...
```
```{r plot_lcop1_hist}
plot_lcop1_hist<- ggplot(df_norm_plank,aes(lcop1)) + geom_histogram(binwidth=0.05, color="white", fill="steelblue") + theme_minimal() + labs(x = "Plankton", y = "Liczba") + ggtitle("Histogram poziomu planktonu") 
...
```
```{r plot_lcop2_hist}
plot_lcop2_hist<- ggplot(df_norm_plank,aes(lcop2)) + geom_histogram(binwidth=0.05, color="white", fill="steelblue") + theme_minimal() + labs(x = "Plankton", y = "Liczba") + ggtitle("Histogram poziomu planktonu") 
